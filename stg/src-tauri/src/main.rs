...
use reportes::puj::{reportes_puj_actualizarfecha,reportes_puj_recibir_nombrereporte,reportes_puj_leer_universitarios_aprobados,reporte_puj_generar} ;
use reportes::colegios::{reportes_colegios_actualizarfecha,reportes_colegios_recibir_nombrereporte,reportes_colegios_generar,reportes_colegios_leer_estudiantes_aprobados} ;
